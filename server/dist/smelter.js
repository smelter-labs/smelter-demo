...
exports.SmelterInstance = exports.SmelterManager = void 0;
...
class SmelterManager {
    ...
    async init() {
        ...
        await exports.SmelterInstance['instance'].registerFont('https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto+Mono:ital,wght@0,100..700;1,100..700&display=swap');
    }
    async registerOutput(roomId) {
        ...
        return { id: roomId, url: `${config_1.config.whepBaseUrl}/${encodeURIComponent(roomId)}`, store };
    }
