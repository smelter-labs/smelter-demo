...
export default function RoomPreviewPage() {
  ...
  return (
    <div className='min-h-screen w-full bg-black-100 text-white flex items-center justify-center p-4'>
      <div className='w-full max-w-6xl'>
        <div className='w-full max-w-[1920px] mx-auto'>
          {loading ? (
            ...
            <OutputStream whepUrl={roomState.whepUrl} videoRef={videoRef} />
          )}
        </div>
